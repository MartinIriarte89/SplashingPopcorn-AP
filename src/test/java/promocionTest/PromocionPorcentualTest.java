...
public class PromocionPorcentualTest {
	...
	public void setup() {
		...
		miPromo = new PromocionPorcentual(1, "Animate a la acción", misPeliculas, 20, null, null, "porcentual");
	}
	...
	public void noMostrarPromocionSiNoTieneCupoTest() {
		...
		Promocion promo = new PromocionPorcentual(1, "Animate a la acción", peliculas, 20, null, null, "porcentual");
		promo.restarStock();
