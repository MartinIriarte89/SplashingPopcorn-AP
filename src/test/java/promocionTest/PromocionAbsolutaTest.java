...
public class PromocionAbsolutaTest {
	...
	public void setup() {
		...
		miPromo = new PromocionAbsoluta(1, "Animate a la acción", misPeliculas, 480, null, null, "absoluta");
	}
	...
	public void noMostrarPromocionSiNoTieneCupoTest() {
		...
		Promocion promo = new PromocionAbsoluta(1, "Animate a la acción", peliculas, 300, null, null, "porcentual");
		promo.restarStock();
