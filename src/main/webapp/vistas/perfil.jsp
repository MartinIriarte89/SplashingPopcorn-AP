	...
	<main>
		...
		<div
			...
			<div
				...
				<!--FOTO DE PERFIL-->
				<div class="d-flex col col-md-6 col-xl-5 pe-md-1">
					<div
				...
				<div class="col col-md-12 col-xl-10 order-md-2 mt-1">
					<div class="row m-0 p-0 font-merriweather">
						...
						<div class="row m-0 mt-1 p-0 contenedor">
							<div
								class="col-8 d-flex justify-content-center align-items-center texto">Edita
								tus datos personales</div>
							<div class="col-4 col-sm-2 text-center font-lato texto mt-1 py-3">
								...
								<div
									...
									<div
										...
										<div id="contraRepetida" class="invalid-feedback">
											<c:out value='${erroresContrasena.get("contrasenaRepetida")}'></c:out>
										</div>
									</div>
								</div>
							</div>
